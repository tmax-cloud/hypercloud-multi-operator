...
func (in *ClusterUpdateClaimList) DeepCopyInto(out *ClusterUpdateClaimList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ClusterUpdateClaim, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ClusterUpdateClaimList) DeepCopy() *ClusterUpdateClaimList {
	if in == nil {
		return nil
	}
	out := new(ClusterUpdateClaimList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterUpdateClaimSpec) DeepCopy() *ClusterUpdateClaimSpec {
	if in == nil {
		return nil
	}
	out := new(ClusterUpdateClaimSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterUpdateClaimStatus) DeepCopy() *ClusterUpdateClaimStatus {
	if in == nil {
		return nil
	}
	out := new(ClusterUpdateClaimStatus)
	in.DeepCopyInto(out)
	return out
}
